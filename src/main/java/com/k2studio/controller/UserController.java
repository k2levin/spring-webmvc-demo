...
public class UserController {
	...
	public HashMap<String, String> postUser9(
		@RequestParam @Size(min = 2, max = 8, message = "length must be between {min} and {max}") String name1,
		@RequestParam @Size(min = 2, max = 8, message = "length must be between {min} and {max}") String name2
	) {
		HashMap<String, String> data = new HashMap<String, String>();
